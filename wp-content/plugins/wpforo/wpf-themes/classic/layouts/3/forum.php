...
<div class="wpfl-3">
	<div class="wpforo-category">
	    ...
	    <div class="cat-stat-posts"><?php wpforo_phrase('Replies') ?></div>
	...
	<?php foreach($forums as $forum) : 
		...
		<div class="forum-wrap">
		    <div class="wpforo-forum">
		        ...
		        <div class="wpforo-forum-stat-questions"><?php echo intval($counts['topics']) ?></div>
		        <div class="wpforo-forum-stat-answers"><?php echo intval($wpforo->topic->get_sum_answer($data)) ?></div>
		        <div class="wpforo-forum-stat-posts"><?php echo intval($counts['posts']) ?></div>
		    </div><!-- wpforo-forum -->
