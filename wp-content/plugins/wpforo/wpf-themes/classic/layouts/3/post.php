		              ...
		              <div class="wpforo-post wpfcl-1">
		                	...
		                	<div class="wpforo-post-voting">
		                    	<div class="wpf-positive">
		                    		<?php 
										...
										$wpforo->tpl->buttons( $buttons, $forum_data['forumid'], $topic['topicid'], $post['postid'], $is_topic );  
		                       	 	?>
		                    	</div>
		                ...
		                <div class="wpf-right">
                        	<div class="wpforo-post-content-top">
                                <div class="wpforo-post-link"><?php $buttons = array( 'link' ); $wpforo->tpl->buttons( $buttons, $forum_data['forumid'], $topic['topicid'], $post['postid'], $is_topic ); ?></div>
						              ...
						              <div class="wpforo-comment wpfcl-1">
						                ...
						                <div class="wpf-right">
						                    <div class="wpforo-comment-content">
						                        <?php echo wpforo_kses($comment['body'], 'post') ?> 
						                        ...
						                        <div class="wpforo-comment-action-links">&nbsp;
						                        	<?php 
														...
														$wpforo->tpl->buttons( $buttons, $forum_data['forumid'], $comment['topicid'], $comment['postid'] );
													?>
						                        </div>
						                    </div>
						                </div><!-- right -->
