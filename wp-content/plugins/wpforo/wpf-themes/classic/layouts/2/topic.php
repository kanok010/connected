...
?>
	...
	<div class="wpfl-2">
		...
		<div class="wpforo-topic-head">
			...
			<div class="head-stat-posts"><?php wpforo_phrase('Reply') ?></div>
			<br class="wpf-clear">
		</div>
          ...
          <div class="topic-wrap">
              <div class="wpforo-topic">
                  ...
                  <div class="wpforo-topic-info">
                    <p class="wpforo-topic-title"><a href="<?php echo esc_url($wpforo->topic->get_topic_url($topic, $forum_data)) ?>"><?php echo esc_html($topic['title']) ?></a></p>
