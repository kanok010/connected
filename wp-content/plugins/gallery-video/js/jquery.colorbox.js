...
(function ($, document, window) {
	...
	publicMethod.position = function (speed, loadedCallback) {
		...
		function modalDimensions() {
			...
			$content[0].style.height = $leftBorder[0].style.height = $rightBorder[0].style.height = (parseInt($box[0].style.width,10)*0.562- interfaceHeight+43)+'px';
		}
	...
	publicMethod.prep = function (object) {
		...
		.css({height: 0.5625*getWidth()})// sets the height independently from the width in case the new width influences the value of height.
		.prependTo($content);
